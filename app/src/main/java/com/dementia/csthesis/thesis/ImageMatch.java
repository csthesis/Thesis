...
public class ImageMatch extends AppCompatActivity {
    ...
    public void setColor(){
        ...
        switch (sc) {
            case 1:
                base.setBackgroundResource(R.drawable.crying);
                break;

            case 2:
                base.setBackgroundResource(R.drawable.piano);
                break;

            case 3:
                base.setBackgroundResource(R.drawable.note);
                break;

            case 4:
                base.setBackgroundResource(R.drawable.dog);
                break;

            case 5:
                base.setBackgroundResource(R.drawable.cat);
                break;

            case 6:
                base.setBackgroundResource(R.drawable.violin);
                break;

            case 7:
                base.setBackgroundResource(R.drawable.star);
                break;

            case 8:
                base.setBackgroundResource(R.drawable.elephant);
                break;
        }
    }
