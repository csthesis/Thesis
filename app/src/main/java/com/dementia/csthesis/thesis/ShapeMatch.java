...
public class ShapeMatch extends AppCompatActivity {
    ...
    public void setColor(){
        ...
        switch (sc) {
            case 1:
                base.setBackgroundResource(R.drawable.star1);
                break;

            case 2:
                base.setBackgroundResource(R.drawable.heart1);
                break;

            case 3:
                base.setBackgroundResource(R.drawable.diamond);
                break;

            case 4:
                base.setBackgroundResource(R.drawable.square);
                break;

            case 5:
                base.setBackgroundResource(R.drawable.bilog);
                break;

            case 6:
                base.setBackgroundResource(R.drawable.hexagon);
                break;

            case 7:
                base.setBackgroundResource(R.drawable.pentagon);
                break;

            case 8:
                base.setBackgroundResource(R.drawable.tri);
                break;
        }
    }
